...
def load_data():
  path = r"C:\Users\Administrator\Documents\people.xlsx"
...
treeScrool = ttk.Scrollbar(treeFrame)
treeScrool.pack(side="right", fill="y")

cols = ["Name", "Age", "Subscription", "Employment"]
treeview = ttk.Treeview(treeFrame, show="headings", yscrollcommand=treeScrool.set ,columns=cols, height=13)
treeview.column("Name", width=100)
treeview.column("Age", width=50)
treeview.column("Subscription", width=100)
treeview.column("Employment", width=100)
treeview.pack()
treeScrool.config(command=treeview.yview)
load_data()
